...
var EmployeeDetailsComponent = /** @class */ (function () {
    function EmployeeDetailsComponent(store) {
        this.store = store;
    ...
    EmployeeDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.employeeDetails$.subscribe(function (val) {
            _this.employeeDetails = val.EmployeeList;
            console.log(_this.employeeDetails);
        });
    };
    EmployeeDetailsComponent.prototype.addNewEmployee = function (employeedata) {
        var empData = {
...
var addEmployee = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Employee Data] Add new Employee', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
/* harmony import */ var _employee_employee_action__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../employee/employee.action */ "./src/app/employee/employee.action.ts");
...
var employeeReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_employee_employee_action__WEBPACK_IMPORTED_MODULE_2__["addEmployee"], function (state, _a) {
    var payload = _a.payload;
    return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { EmployeeList: tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state.EmployeeList, [payload]) });
}));
